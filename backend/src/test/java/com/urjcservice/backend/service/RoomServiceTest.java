...
public class RoomServiceTest {
    ...
    public void testFindAll() {
        when(roomRepository.findAll(any(Pageable.class)))
                .thenReturn(new PageImpl<>(Arrays.asList(new Room(), new Room())));
    ...
    public void testUpdateRoomAddingAndRemovingSoftware() {
        ...
        Software softA = new Software();
        softA.setId(10L);
        softA.setName("Old Soft");

        // new software to add
        Software softB = new Software();
        softB.setId(20L);
        softB.setName("New Soft");
