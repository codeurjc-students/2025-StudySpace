...
public class NoSuchElementExceptionCA {
    ...
    public ResponseEntity<String> handleNotFound(NoSuchElementException exception) { // IT IS NOT USED BUT NEEDED TO
                                                                                     // RETURN 404
    ...
    public ResponseEntity<Object> handleDisabledUser(DisabledException ex) {
        ...
        body.put("status", HttpStatus.UNAUTHORIZED.value());
        body.put("error", "Unauthorized");
        body.put("message", "User is disabled or not verified");
